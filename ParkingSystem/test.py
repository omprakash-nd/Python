...
class TestParkApplication(unittest.TestCase):
    ...
    def test_floor(self):
        ...
        self.assertEqual((self.test_floor.floor_no), "floor2")
   
    def test_park(self):
        self.test_floor = Floor("floor1")
        self.test_floor.set_slot("Car", 1)
        self.test_vehicle = Vehicle("Car", 1234)
    ...
    def test_unpark(self):
        self.test_floor = Floor("floor1")
        self.test_floor.set_slot("Car", 1)
        self.test_vehicle = Vehicle("Car", 3555)   
        self.assertNotEqual(self.test_floor.park(self.test_vehicle), 1234)
    ...
    def test_check_vehicle(self):
        self.test_floor = Floor("floor1")
        self.test_floor.set_slot("Car", 1)
        self.test_vehicle = Vehicle("Van", 1234)
        self.test_parking_controller = ParkingController()
        self.test_parking_controller.__add__(self.test_floor)
